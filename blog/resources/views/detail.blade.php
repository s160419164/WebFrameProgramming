            ...
            <div class="content">
                @if( $detailid=='medicine_1')
                    <div>
                        ...
                        <div>
                            ...
                            <h4>Paracetamol adalah obat untuk meredakan demam dan nyeri, termasuk nyeri haid atau sakit gigi. 
                ...
                @elseif($detailid=='medicine_2')
                        <div>
                            ...
                            <div><img src="{{asset('img/promag.jpg')}}"/><h4>Promag bermanfaat untuk mengatasi sakit maag, penyakit asam lambung naik, dan perut kembung. 
                ...
                @elseif($detailid=='medicine_3')
                        <div>
                            ...
                            <div><img src="{{asset('img/konidin.jpg')}}"/><h4>Konidin bermanfaat untuk mengobati batuk berdahak, kering, batuk yang disebabkan oleh alergi hingga 
                ...
                @elseif($detailid=='equip_1')
                         <div>
                            ...
                            <div><img src="{{asset('img/stetoskop.jpg')}}"/><h4>Alat ini berfungsi untuk mendengarkan suara yang terdapat di dalam tubuh. Seperti suara paru-paru, 
                ...
                @elseif($detailid=='equip_2')
                        <div>
                           ...
                           <div><img src="{{asset('img/tensimeter.jpg')}}"/><h4>Tensimeter atau sfigmomanometer merupakan alat yang digunakan untuk mengukur tekanan darah</h4></div>
                        </div><br>
                @elseif($detailid=='equip_3')
                        <div>
                           <div><h2><a href="{{route('detailequip',['id'=>'equip_3'])}}">Penlight</a></h4></div>
                           <div><img src="{{asset('img/penlight.jpg')}}"/>
                           <h4>Penlight merupakan intrumen kedokteran yang berguna untuk memeriksa di daerah gelap seperti rongga mulut, telinga, dll.</h4></div>
                        </div><br>
                @endif
            </div>
        </div>
